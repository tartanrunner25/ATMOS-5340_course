...
<br>
A few more things about Python<br>
- Python is dynamically typed<br>
    - Variables generally do not need to be declared before using them (i.e real, string, integer)<br>
- Python has a robust built-in set of data types, and users are free to define additional structures.<br>
- Python is **case sensitive**.<br>
    - Pressure, pressure, PRESSURE will be 3 completely different variables!<br>
- Python is object oriented <br>
    - A programming paradigm based on the concept of "objects", which can contain data, in the form of fields (often known as attributes or properties), and code, in the form of procedures<br>
- Platform independent, open-source, and free!<br>
<br>
