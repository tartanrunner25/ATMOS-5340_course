...
If Python is installed on your Mac, open the **terminal** or **xquartz**.
If Python is not installed on your Mac, log onto CHPC with **Open OnDemend**, and create a linux terminal session...
